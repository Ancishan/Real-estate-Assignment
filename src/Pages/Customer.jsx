...
import man2 from '../assets/man8.jpg';
    ...
    return (
        <div className=' mt-16 mb-16'>
            ...
            <Marquee pauseOnHover={true} speed={100}>
                ...
                <div className="card card-compact w-96 bg-base-100 shadow-xl ">
                <img src={man2} alt="" className='w-20 h-20 mt-2 rounded-full mx-auto'/>
                    <div className="card-body">
                    <h2 className='card-title text-2xl text-green-400 font-semibold mx-auto'>Mr.DOn</h2>
                    <p className='text-lg '>I  Farm  I must say, it was an absolutely delightful experience from start to finish. From the moment we arrived, we were greeted warmly by the staff</p>
                    </div>
                </div>
                <div className="card card-compact w-96 bg-base-100 shadow-xl ">
