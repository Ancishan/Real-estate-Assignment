...
const BannerSec = () => {
    ...
    return (
        <div ref={ref} className="carousel z-[1] pt-30 h-[40vh] md:h-[70vh] mt-4 mx-auto ml-3 mr-3 rounded-lg font-poppins md:relative">
            <div id="slide1" className={` z-[1] carousel-item relative w-full ${triggerAnimation ? 'aos-animate' : ''}`} data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="200">
                ...
                <div className='absolute top-1/3 left-1/3 transform -translate-x-1/2 -translate-y-1/2' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                    <h2 className='text-xl font-bold md:text-5xl  text-green-500 ' data-aos="fade-right" data-aos-duration="3000" data-aos-delay="500" >Welcome <br /> To  <br /> Pranti Agro Farm</h2>
                    <p className=' text-sm md:text-xl text-green-400 pt-3' data-aos="fade-up-left" data-aos-duration="1000" data-aos-delay="700">where we nurture healthy cows and promote sustainable farming practices.</p>
                </div>
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide4" className="btn w-4 h-4 md:btn-circle">❮</a>
                    <a href="#slide2" className="btn w-4 h-4 md:btn-circle">❯</a>
                </div>
            </div>
            <div id="slide2" className={`z-[1] carousel-item relative w-full ${triggerAnimation ? 'aos-animate' : ''}`} data-aos="fade-right" data-aos-duration="2000"  data-aos-delay="500">
                ...
                <div className='absolute top-1/3 left-1/3 transform -translate-x-1/2 -translate-y-1/2' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                    <h2 className='text-xl font-bold md:text-5xl text-green-500 ' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">Welcome <br /> To  <br /> Pranti Agro Farm</h2>
                    <p className='text-green-400 text-sm md:text-xl' data-aos="fade-up-left" data-aos-duration="1000" data-aos-delay="1000">where we nurture healthy cows and promote sustainable farming practices.</p>
                </div>
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide1" className="btn w-4 h-4 md:btn-circle">❮</a>
                    <a href="#slide3" className="btn w-4 h-4 md:btn-circle">❯</a>
                </div>
            </div>
